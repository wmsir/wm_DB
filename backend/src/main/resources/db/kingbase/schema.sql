-- ================================================================
-- WMdb 智能云平台 - 国产人大金仓 (KingbaseES KES V8 / V9) 全量表结构
-- 适用引擎：人大金仓 KingbaseES V8R3 / V8R6 / V9
-- ================================================================
...
CREATE TABLE IF NOT EXISTS sys_role (
  ...
  CONSTRAINT uk_kes_role UNIQUE (tenant_id, role_code)
);
...
CREATE TABLE IF NOT EXISTS sys_user (
  ...
  CONSTRAINT uk_kes_user UNIQUE (tenant_id, username)
);
...
CREATE TABLE IF NOT EXISTS resource_group (
  ...
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT uk_kes_group UNIQUE (tenant_id, group_name)
);
...
CREATE TABLE IF NOT EXISTS db_instance (
  ...
  CONSTRAINT uk_kes_inst UNIQUE (tenant_id, name)
);
